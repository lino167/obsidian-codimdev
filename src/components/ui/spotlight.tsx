...
export const SpotlightNew = ({ className = "" }: { className?: string }) => {
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          opacity,
          background: `radial-gradient(600px circle at ${position.x}px ${position.y}px, rgba(186, 12, 16, 0.15), transparent 40%)`,
        }}
      />
    </div>
  );
